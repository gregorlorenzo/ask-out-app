    ...
    <div className={cn(
      ...
      <div className="p-4 space-y-4 flex-grow">
        ...
        <nav className="space-y-1">
          ...
          <SidebarItem icon={FileQuestion} to="/quiz" isCollapsed={isCollapsed}>
            Quiz
          </SidebarItem>
          <SidebarItem icon={FileText} to="/letter" isCollapsed={isCollapsed}>
            Letter
          </SidebarItem>
          <SidebarItem icon={Presentation} to="/slideshow" isCollapsed={isCollapsed}>
            Slideshow
          </SidebarItem>
        </nav>
      </div>
